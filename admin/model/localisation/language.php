...
class ModelLocalisationLanguage extends Model {
	public function addLanguage($data) {		
		...
		$language_id=1+(int)$this->mongodb->getlastid($collection,'language_id');
		$where=array('language_id'=>(int)$language_id, 'name'=>$data['name'], 'code'=>$data['code'], 'locale'=>$data['locale'], 'directory'=>$data['directory'], 'image'=>$data['image'], 'sort_order'=>(int)$data['sort_order'], 'status'=>(int)$data['status']);
	...
	public function editLanguage($language_id, $data) {
		$collection="mongo_language";
		$infoupdate=array('language_id'=>(int)$language_id, 'name'=>$data['name'], 'code'=>$data['code'], 'locale'=>$data['locale'], 'directory'=>$data['directory'], 'image'=>$data['image'], 'sort_order'=>(int)$data['sort_order'], 'status'=>(int)$data['status']);
	...
	public function getTotalLanguages() {
		...
		$collection="mongo_language";$language_data= array();
		$where=array();
		$language_data=$this->mongodb->gettotal($collection,$where);
		return $language_data;
	}
}