				...
				if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
					if (isset($product_option['product_option_value'])) {
						...
						foreach ($product_option['product_option_value'] as $product_option_value) {
							...
							$newdocument=array('product_option_value_id'=>(int)$product_option_value_id, 'product_option_id'=>(int)$product_option_id, 'product_id'=>(int)$product_id, 'option_id'=>(int)$product_option['option_id'], 'option_value_id'=>(int)$product_option_value['option_value_id'], 'quantity'=>(int)$product_option_value['quantity'], 'subtract'=>(int)$product_option_value['subtract'], 'price'=>(float)$price, 'price_prefix'=>$product_option_value['price_prefix'], 'points'=>(int)$product_option_value['points'], 'points_prefix'=>$product_option_value['points_prefix'], 'weight'=>(float)$product_option_value['weight'], 'weight_prefix'=>(int)$product_option_value['weight_prefix']);
							$this->mongodb->create($collection,$newdocument); 
						}
					}
				} else {
...
//die();
	...
	public function getProduct($product_id) {
		...
		//return $query->row;$category_info = array();
		$product_info = array();
		$collection="mongo_product";
		$where=array('product_id'=>(int)$product_id);
		$product_info=$this->mongodb->getBy($collection,$where);
