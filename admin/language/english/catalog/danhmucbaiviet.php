...
// Text
$_['text_success']           = 'Success: You have modified article categories!';
...
$_['entry_createby']           = 'Create By';
$_['entry_updateby']           = 'Update By';
$_['entry_accessby']           = 'Access';
$_['entry_classname']           = 'Css class';

// Help
$_['help_filter']            = '(Autocomplete)';
$_['help_keyword']           = 'Do not use spaces, instead replace spaces with - and make sure the keyword is globally unique.';
$_['help_top']               = 'Display in the top menu bar. Only works for the top parent article categories.';
$_['help_column']            = 'Number of columns to use for the bottom 3 categories. Only works for the top parent categories.';

// Error
$_['error_warning']          = 'Warning: Please check the form carefully for errors!';
$_['error_permission']       = 'Warning: You do not have permission to modify article categories!';
