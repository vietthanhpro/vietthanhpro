              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="voucher_theme_id" id="input-theme" class="form-control">
                    ...
                    <option value="<?php echo $voucher_theme['voucher_theme_id']; ?>" selected="selected"><?php echo $voucher_theme['voucher_theme_description'][$config_language_id]['name']; ?></option>
                    <?php } else { ?>
