    ...
    <div class="modal-body">
      <div class="row">
        <div class="col-sm-5"><a href="<?php echo $parent; ?>" data-toggle="tooltip" title="<?php echo $button_parent; ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
          ...
          <button type="button" data-toggle="tooltip" title="<?php echo $button_multiupload; ?>" id="button-multiupload" class="btn btn-primary"><i class="fa fa-cloud-upload"></i></button>
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file[]\']').val() != '') {
			...
			$.ajax({
				...
				processData: false,		
				beforeSend: function() {
					$('#button-multiupload i').replaceWith('<i class="fa fa-circle-o-notch fa-spin"></i>');
					$('#button-multiupload').prop('disabled', true);
				},
				complete: function() {
					$('#button-multiupload i').replaceWith('<i class="fa fa-upload"></i>');
					$('#button-multiupload').prop('disabled', false);
				},
