            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><span data-toggle="tooltip" title="<?php echo $product['createby']; ?>"><?php echo $product['date_added']; ?></span></td>
                  <td class="text-left"><span data-toggle="tooltip" title="<?php echo $product['updateby']; ?>"><?php echo $product['date_modified']; ?></span></td>
