              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="tag_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($tag_description[$language['language_id']]) ? $tag_description[$language['language_id']]['description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group required">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($type['type_id'], $tag_type)) { ?>
                        <input type="checkbox" name="tag_type[]" value="<?php echo $type['type_id']; ?>" checked="checked" />
                        <?php echo $type['type_description'][$config_language_id]['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="tag_type[]" value="<?php echo $type['type_id']; ?>" />
                        <?php echo $type['type_description'][$config_language_id]['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
...
$('input[name=\'path\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/tag/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',
