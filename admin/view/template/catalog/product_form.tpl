              ...
              <div class="tab-content">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="product-tag" class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div id="product-tag<?php echo $product_tag['tag_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $product_tag['name']; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="length_class_id" id="input-length-class" class="form-control">
                    ...
                    <option value="<?php echo $length_class['length_class_id']; ?>" selected="selected"><?php echo $length_class['length_class_description'][$config_language_id]['title']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $length_class['length_class_id']; ?>"><?php echo $length_class['length_class_description'][$config_language_id]['title']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="weight_class_id" id="input-weight-class" class="form-control">
                    ...
                    <option value="<?php echo $weight_class['weight_class_id']; ?>" selected="selected"><?php echo $weight_class['weight_class_description'][$config_language_id]['title']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $weight_class['weight_class_id']; ?>"><?php echo $weight_class['weight_class_description'][$config_language_id]['title']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><select name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
                                  ...
                                  <option value="<?php echo $option_value['option_value_id']; ?>" selected="selected"><?php echo $option_value['option_value_description'][$config_language_id]['name']; ?></option>
                                  <?php } else { ?>
                                  <option value="<?php echo $option_value['option_value_id']; ?>"><?php echo $option_value['option_value_description'][$config_language_id]['name']; ?></option>
                                  <?php } ?>
                                  <?php } ?>
                                  <?php } ?>
                                </select>
                  ...
                  <tbody>
                    ...
                    <tr id="recurring-row<?php echo $recurring_row; ?>">
                      <td class="text-left"><select name="product_recurrings[<?php echo $recurring_row; ?>][recurring_id]" class="form-control">
                          ...
                          <option value="<?php echo $recurring['recurring_id']; ?>" selected="selected"><?php echo $recurring['recurring_description'][$config_language_id]['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $recurring['recurring_id']; ?>"><?php echo $recurring['recurring_description'][$config_language_id]['name']; ?></option>
                          <?php } ?>
                          <?php } ?>
                        </select></td>
                      <td class="text-left"><select name="product_recurrings[<?php echo $recurring_row; ?>][customer_group_id]" class="form-control">
                          ...
                          <option value="<?php echo $customer_group['customer_group_id']; ?>" selected="selected"><?php echo $customer_group['customer_group_description'][$config_language_id]['name']; ?></option>
                          <?php } else { ?>
                          <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['customer_group_description'][$config_language_id]['name']; ?></option>
                          <?php } ?>
                          <?php } ?>
                        </select></td>
              ...
              <div class="table-responsive">
                <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php foreach ($customer_groups as $customer_group) { ?>
                    <tr>
                      <td class="text-left"><?php echo $customer_group['customer_group_description'][$config_language_id]['name']; ?></td>
...
$('input[name=\'tag\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/tag/autocomplete&token=<?php echo $token; ?>&tag_to_type=1&filter_name=' +  encodeURIComponent(request),
			dataType: 'json',			
			success: function(json) {
				response($.map(json, function(item) {
					return {
...
function addDiscount() {
    ...
    <?php foreach ($customer_groups as $customer_group) { ?>
    html += '    <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo addslashes($customer_group['customer_group_description'][$config_language_id]['name']); ?></option>';
    <?php } ?>
    html += '  </select></td>';		
...
function addRecurring() {
	...
	<?php foreach ($recurrings as $recurring) { ?>
	html += '      <option value="<?php echo $recurring['recurring_id']; ?>"><?php echo $recurring['recurring_description'][$config_language_id]['name']; ?></option>';
	<?php } ?>
	html += '    </select>';
	html += '  </td>';
	html += '  <td class="left">';
	...
	<?php foreach ($customer_groups as $customer_group) { ?>
	html += '      <option value="<?php echo $customer_group['customer_group_id']; ?>"><?php echo $customer_group['customer_group_description'][$config_language_id]['name']; ?></option>';
	<?php } ?>
	html += '    <select>';
	html += '  </td>';
	html += '  <td class="left">';
