                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="checkbox">
                      <label>
                        ...
                        <?php echo $customer_group['customer_group_description'][$config_language_id]['name']; ?>
                        <?php } else { ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="config_account_id" id="input-account" class="form-control">
                      ...
                      <option value="<?php echo $information['information_id']; ?>" selected="selected"><?php echo $information['information_description'][$config_language_id]['title']; ?></option>
                      <?php } else { ?>
                      <option value="<?php echo $information['information_id']; ?>"><?php echo $information['information_description'][$config_language_id]['title']; ?></option>
                      <?php } ?>
                      <?php } ?>
                    </select>
                  </div>
