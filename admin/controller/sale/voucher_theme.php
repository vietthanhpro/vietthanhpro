...
class ControllerSaleVoucherTheme extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_sale_voucher_theme->getVoucherThemes($filter_data);
		$results=$data_results['results'];
		$voucher_theme_total = $data_results['count'];

		foreach ($results as $result) {
			$data['voucher_themes'][] = array(
				'voucher_theme_id' => $result['voucher_theme_id'],
				//'name'             => $result['name'],
				'name'              => $result['voucher_theme_description'][(int)$this->config->get('config_language_id')]['name'],
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['voucher_theme_id'])) {
			...
			$data['voucher_theme_description'] = $voucher_theme_info['voucher_theme_description']; 
		} else {
