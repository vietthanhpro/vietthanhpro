...
class ControllerSaleCustomerGroup extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_sale_customer_group->getCustomerGroups($filter_data);
		$results=$data_results['results'];
		$customer_group_total = $data_results['count'];
		...
		foreach ($results as $result) {
			$data['customer_groups'][] = array(
				...
				'name'              => $result['customer_group_description'][(int)$this->config->get('config_language_id')]['name'] . (($result['customer_group_id'] == $this->config->get('config_customer_group_id')) ? $this->language->get('text_default') : null),
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['customer_group_id'])) {
			...
			$data['customer_group_description'] = $customer_group_info['customer_group_description']; 
		} else {
