...
class ControllerCatalogManufacturer extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_catalog_manufacturer->getManufacturers($filter_data);
		$results=$data_results['results'];
		$manufacturer_total = $data_results['count'];
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['manufacturer_id'])) {
			...
			$data['manufacturer_store'] = $manufacturer_info['manufacturer_to_store']; 
		} else {
