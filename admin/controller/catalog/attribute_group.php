...
class ControllerCatalogAttributeGroup extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_catalog_attribute_group->getAttributeGroups($filter_data);
		$results=$data_results['results'];
		$attribute_group_total = $data_results['count'];

		foreach ($results as $result) {
			$data['attribute_groups'][] = array(
				'attribute_group_id' => $result['attribute_group_id'],
				'name'               => $result['attribute_group_description'][$this->config->get('config_language_id')]['name'],
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['attribute_group_id'])) {
			...
			$data['attribute_group_description'] = $attribute_group_info['attribute_group_description']; 
		} else {
