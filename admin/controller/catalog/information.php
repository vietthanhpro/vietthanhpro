...
class ControllerCatalogInformation extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_catalog_information->getInformations($filter_data);
		$results=$data_results['results'];
		$information_total = $data_results['count'];

		foreach ($results as $result) {
			$data['informations'][] = array(
				'information_id' => $result['information_id'],
				'title'          => $result['information_description'][$this->config->get('config_language_id')]['title'],
		...
		$data['sort_title'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'] . '&sort=title' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('catalog/information', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, 'SSL');
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['information_id'])) {
			...
			$data['information_store'] = $information_info['information_to_store']; 
		} else {
