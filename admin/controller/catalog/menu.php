...
class ControllerCatalogMenu extends Controller {
	...
	protected function getList() {
		...
		$data['add'] = $this->url->link('catalog/menu/add', 'token=' . $this->session->data['token'] . $url, 'SSL');
		...
		$data_results = $this->model_catalog_menu->getMenus($filter_data);
		$results=$data_results['results'];
		$menu_total = $data_results['count'];

		foreach ($results as $result) {
			$data['menus'][] = array(
				'menu_id' => $result['menu_id'],
				'name'          => $result['menu_description'][$this->config->get('config_language_id')]['name'],
	...
	protected function getForm() {
		...
		if (isset($this->request->post['menu_store'])) {
			...
			$data['menu_store'] = $menu_info['menu_to_store']; 
		} else {
