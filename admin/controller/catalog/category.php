...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['path'])) {
			...
			$data['path'] = $this->model_catalog_category->getPath($category_info['parent_id']);
		} else {
			$data['path'] = '';
		}
		...
		//} elseif (isset($this->request->get['category_id'])) {
			...
			$filters = $category_info['category_filter']; 
		} else {
			$filters = array();
		}
		...
		//} elseif (isset($this->request->get['category_id'])) {
			...
			$data['category_store'] = $category_info['category_to_store']; 
		} else {
