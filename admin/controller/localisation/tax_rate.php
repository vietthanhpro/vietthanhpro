...
class ControllerLocalisationTaxRate extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_localisation_tax_rate->getTaxRates($filter_data);
		$results=$data_results['results'];
		$tax_rate_total = $data_results['count'];
		$this->load->model('localisation/geo_zone');

		foreach ($results as $result) {
			$geo_zone_info = $this->model_localisation_geo_zone->getGeoZone($result['geo_zone_id']);
		...
		$data['sort_name'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=name' . $url, 'SSL');
		$data['sort_rate'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=rate' . $url, 'SSL');
		$data['sort_type'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=type' . $url, 'SSL');
		$data['sort_geo_zone'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=geo_zone_id' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
		$data['sort_date_modified'] = $this->url->link('localisation/tax_rate', 'token=' . $this->session->data['token'] . '&sort=date_modified' . $url, 'SSL');
