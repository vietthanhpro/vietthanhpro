...
class ControllerLocalisationLengthClass extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_localisation_length_class->getLengthClasses($filter_data);
		$results=$data_results['results'];
		$length_class_total = $data_results['count'];
		
		foreach ($results as $result) {
			$data['length_classes'][] = array(
				'length_class_id' => $result['length_class_id'],
				'title'           => $result['length_class_description'][(int)$this->config->get('config_language_id')]['title'] . (($result['length_class_id'] == $this->config->get('config_length_class_id')) ? $this->language->get('text_default') : null),
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['length_class_id'])) {
			...
			$data['length_class_description'] = $length_class_info['length_class_description']; 
		} else {
