...
class ControllerLocalisationWeightClass extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_localisation_weight_class->getWeightClasses($filter_data);
		$results=$data_results['results'];
		$weight_class_total = $data_results['count'];

		foreach ($results as $result) {
			$data['weight_classes'][] = array(
				'weight_class_id' => $result['weight_class_id'],
				'title'           => $result['weight_class_description'][(int)$this->config->get('config_language_id')]['title'] . (($result['weight_class_id'] == $this->config->get('config_weight_class_id')) ? $this->language->get('text_default') : null),
	...
	protected function getForm() {
		...
		//} elseif (isset($this->request->get['weight_class_id'])) {
			...
			$data['weight_class_description'] = $weight_class_info['weight_class_description']; 
		} else {
