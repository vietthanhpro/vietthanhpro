...
class ControllerDesignBanner extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_design_banner->getBanners($filter_data);
		$results=$data_results['results'];
		$banner_total = $data_results['count'];
	...
	protected function getForm() {
		...
		if (isset($this->request->post['banner_image'])) {
			...
			$banner_images = (array)$banner_info['banner_images'];
		} else {
			$banner_images = array();
		}
