...
class ControllerMarketingCoupon extends Controller {
	...
	protected function getList() {
		...
		$data_results = $this->model_marketing_coupon->getCoupons($filter_data);
		$results=$data_results['results'];
		$coupon_total = $data_results['count'];

		foreach ($results as $result) {
			$date_start=(array)$result['date_start'];
			$date_end=(array)$result['date_end'];
			$data['coupons'][] = array(
				...
				'date_start'     => date($this->language->get('date_format_short'),$date_start['sec']),
				//'date_end'   => date($this->language->get('date_format_short'), strtotime($result['date_end'])),
				'date_end'     => date($this->language->get('date_format_short'),$date_end['sec']),
