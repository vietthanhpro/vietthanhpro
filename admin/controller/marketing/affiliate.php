...
class ControllerMarketingAffiliate extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			...
			$affiliate_balance = $this->model_marketing_affiliate->getSumAffiliatesTransaction($result['affiliate_id']);			
			...
			$data['affiliates'][] = array(
				...
				'balance'      => $this->currency->format($affiliate_balance, $this->config->get('config_currency')),
		...
		$data['sort_email'] = $this->url->link('marketing/affiliate', 'token=' . $this->session->data['token'] . '&sort=email' . $url, 'SSL');
		$data['sort_status'] = $this->url->link('marketing/affiliate', 'token=' . $this->session->data['token'] . '&sort=status' . $url, 'SSL');
		$data['sort_date_added'] = $this->url->link('marketing/affiliate', 'token=' . $this->session->data['token'] . '&sort=date_added' . $url, 'SSL');
