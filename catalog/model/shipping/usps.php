...
class ModelShippingUsps extends Model {
	public function getQuote($address) {
		...
		$where=array('geo_zone_id'=>(int)$this->config->get('usps_geo_zone_id'), 'country_id'=>(int)$address['country_id'],'$or'=>array(array('zone_id'=>(int)$address['zone_id']),array('zone_id'=>0)));
		$order=array();
