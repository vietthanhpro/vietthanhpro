...
class ControllerAffiliateRegister extends Controller {
	...
	public function index() {
		...
		if ($this->config->get('config_affiliate_id')) {
			...
			if ($information_info) {
				$data['text_agree'] = sprintf($this->language->get('text_agree'), $this->url->link('information/information/agree', 'information_id=' . $this->config->get('config_affiliate_id'), 'SSL'), $information_info['information_description'][$this->config->get('config_language_id')]['title'], $information_info['information_description'][$this->config->get('config_language_id')]['title']);
			} else {
				$data['text_agree'] = '';
			}
		} else {
